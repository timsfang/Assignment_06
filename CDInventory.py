...
# Desc: WStarter Script for Assignment 06
...
strID = None # added as global variable so elif choice a line 189 can complete
strTitle = None # added as global variable so elif choice a line 189 can complete
stArtist = None # added as global variable so elif choice a line 189 can complete
...
while True:
    ...
    # 3.3 process add a CD
        ...
        # 3.3.1 Ask user for new ID, CD Title and Artist and adds items to table
        IO.user_input(strID, strTitle, stArtist)
        IO.show_inventory(lstTbl)
        continue  # start loop back at top.
